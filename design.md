# Technical Design: vue-architect-skill v1.0 (Historical)
...
Historical v1.0 design record for the Vue-native architecture skill (`vue-architect`). The active runtime version is now `versions/v3.0/SKILL.md`, with curated references in `versions/v3.0/references/`. Historical claims in this document, including Vite 6-era notes, must be checked against the v3.0 source index before reuse.
...
| ---------------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Vite 8                             | https://vite.dev/blog/announcing-vite8                                                         | Current v3 source-index baseline; verify exact version before new claims  |
...
| ------------------------------ | ------------------------------------------------------------------------------------------- |
| Toolchain (Rolldown, Vite 8)   | See `versions/v3.0/references/source-index.md`; older Vite 6 research is historical only    |
